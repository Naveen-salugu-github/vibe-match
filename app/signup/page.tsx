export default function SignupPage() {
  // Back-compat route: keep /signup but route to OTP flow.
  // This is a Server Component by default, so we do a simple link.
  return (
    <div className="min-h-screen bg-[#0b0f19] px-4 py-16 text-white">
      <div className="mx-auto w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-8 text-center">
        <p className="text-white/70">Sign up now uses email codes.</p>
        <a
          href="/auth/email"
