...
Reason for change   : Initial build — NRF Friday-nearest rule with 2012 override
######################################################
"""
...
# MAGIC 2. For any deviating year add one entry: `{fiscal_year: published_year_end_date}`.
...
#
# The value is the LAST day of that fiscal year (a Friday), NOT the first day.
# Add an entry only when the published calendar deviates from the algorithm.
# Each entry fixes that year and its neighbour automatically.
# ---------------------------------------------------------------------------
